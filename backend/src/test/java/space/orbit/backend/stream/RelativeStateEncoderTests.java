...
class RelativeStateEncoderTests {
    ...
    void envelopeCarriesContractMetadata() throws Exception {
        String json = encoder.encodeRelative(
                ...
                "cw", 5000.0, 0.0006703, 6_771_000.0, List.of(), null, null, List.of(), List.of(), List.of(), List.of());
    ...
    void deputyHasClampedDegreeAndRoundedSamples() throws Exception {
        String json = encoder.encodeRelative(
                Instant.parse("2026-06-02T01:00:00Z"), 30, 25544, null, List.of(), List.of(deputyWithVelocity()), true,
                "sgp4", 0.0, 0.0, 6_771_000.0, List.of(), null, null, List.of(), List.of(), List.of(), List.of());
    ...
    void encodesAttitudeChiefBlockAndSensors() throws Exception {
        ...
        String json = encoder.encodeRelative(
                ...
                List.of(dep), true, "sgp4", 0.0, 0.0, 6_771_000.0, List.of(), null, null, List.of(), List.of(), List.of(), List.of());
        JsonNode root = mapper.readTree(json);
    ...
    void encodesSensorEvents() throws Exception {
        ...
        String json = encoder.encodeRelative(
                Instant.parse("2026-06-02T01:00:00Z"), 30, 25544, null, List.of(), List.of(dep), false,
                "sgp4", 0.0, 0.0, 6_771_000.0, List.of(ev), null, null, List.of(), List.of(), List.of(), List.of());
    ...
    void encodesSunMoonVectorsAndEclipses() throws Exception {
        ...
        String json = encoder.encodeRelative(
                Instant.parse("2026-06-02T01:00:00Z"), 30, 25544, null, List.of(), List.of(dep), false,
                "sgp4", 0.0, 0.0, 6_771_000.0, List.of(), sun, moon, List.of(ecl), List.of(), List.of(), List.of());
        JsonNode root = mapper.readTree(json);
    ...
    void encodesConjunctionsAndViolations() throws Exception {
        ...
        String json = encoder.encodeRelative(
                ...
                List.of(conj), List.of(viol), List.of());
        JsonNode root = mapper.readTree(json);
    ...
    @Test
    void carriesLinkBudgetSeries() throws Exception {
        double[] s = {0, 1, 2, 3, 30, 4, 5, 6};
        var dep = new RelativeSamples(1, "X", 5, s, null, 0.0);
        var lb = new LinkBudgetSeries(25544, "s1", 1, "rf", 10.0, new double[] {0, 18.4, 300, 12.1});
        String json = encoder.encodeRelative(
                Instant.parse("2026-06-02T01:00:00Z"), 30, 25544, null, List.of(), List.of(dep), false,
                "sgp4", 0.0, 0.0, 6_771_000.0, List.of(), null, null, List.of(), List.of(), List.of(), List.of(lb));
        JsonNode root = mapper.readTree(json);
        assertThat(root.get("contractVersion").asText()).isEqualTo("1");
        JsonNode l0 = root.get("linkBudgets").get(0);
        assertThat(l0.get("hostId").asInt()).isEqualTo(25544);
        assertThat(l0.get("sensorId").asText()).isEqualTo("s1");
        assertThat(l0.get("targetId").asInt()).isEqualTo(1);
        assertThat(l0.get("thresholdDb").asDouble()).isEqualTo(10.0);
        assertThat(l0.get("series").get(1).asDouble()).isEqualTo(18.4);
    }
}
